...
# wujin_face_encoding = face_recognition.face_encodings(wujin_image)[0]
#
# # Load a second sample picture and learn how to recognize it.
# wang_image = face_recognition.load_image_file("wang.png")
# wang_face_encoding = face_recognition.face_encodings(wang_image)[0]

# Load myself
xie_image = face_recognition.load_image_file("xie.jpg")
xie_face_encoding = face_recognition.face_encodings(xie_image)[0]
